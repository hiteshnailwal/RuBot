export const APP_CONSTANTS = {
  ...
  MSG_BLOCK_CSS: '.msgBody { width: 90%; margin: 30px auto; font-size: 22px; font-weight: 500; line-height: 16px; text-align: center; color: black; }'
}
